...
<body>
  <table style="width:100%;max-width:960px;position: relative;left:0;right:0;margin: 0 auto;border-collapse: collapse;border-spacing: 0;font-size: 14px;line-height: 24px;color: #333;font-family: Microsoft YaHei;">
    ...
    <tr>
      <td style="padding: 20px 7.5% 0;">Chère, cher {{Auth::user()->email}} ,</td>
    </tr>

    <tr>
      <td style="padding: 20px 7.5% 0;">Juste un petit rappel sur la séance de formation que vous venez de planifier:</td>
    </tr>

    <tr>
      <td style="padding: 20px 7.5% 0;"> Voici les infos sur la session :<br>
        Date et heure: <strong>{{ Carbon\Carbon::parse($classroom->date)->format('d-m-Y H:i') }}</strong> <br>
        Nom de l'étudiant: <strong>{{$classroom->etudiant}}</strong> <br>
      </td>
    </tr>

    <tr>
      <td style="padding: 20px 7.5% 0;">
        Merci de faire de ton mieux pour être à l'heure à la séance.<br>
        Oschool exige la ponctualité aussi bien de la part des étudiants que des formateurs. <br>
        <a href="https://code.oschool.ci/classrooms">Voir mes sessions</a><br>
