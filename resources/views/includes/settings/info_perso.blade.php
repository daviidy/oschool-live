      ...
      <section class="setting-personal-info--content-container--2rXvo form--flex-column--g8OLQ">
        ...
        <div class="setting-personal-info--main--3cA9D form--main--31YLe">
          ...
          <input id="firstNameInput" name="prenoms" type="text" placeholder="Prénoms" class="setting-personal-info--field--1SB0y form--input-field--1iAH4"
            ...
            <label for="emailInput">Nombre Maximum d'étudiants prenables</label>
            <p> <strong>Nombre Maximum d'étudiants prenables</strong> </p>
            <input id="emailInput" name="max_students" type="text" placeholder="Exple: 3" class="setting-personal-info--field--1SB0y form--input-field--1iAH4" value="{{Auth::user()->max_students}}">
