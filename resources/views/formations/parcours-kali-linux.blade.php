...
@section('content')
  ...
  <li _ngcontent-c29="" class="ng-star-inserted">
    ...
    <!---->
    <h5 _ngcontent-c29="" class="ng-star-inserted">1 journée</h5>
    <!---->
    <!---
  ...
  <li class="trait" _ngcontent-c29="" class="ng-star-inserted">
    ...
    <ir-classroom-opens-column _ngcontent-c29="" _nghost-c91="" class="ng-star-inserted">
      <!---->
      <!---->
      <h6 class="details" _ngcontent-c91="" class="ng-star-inserted">Date</h6>
      <!---->
      <h5 _ngcontent-c91="" class="ng-star-inserted"> 2 février 2019 </h5>
      <!---->
      <!---->
  ...
  <li class="trait" _ngcontent-c29="" class="ng-star-inserted">
    ...
    <!---->
     <p _ngcontent-c29="" class="x-small ng-star-inserted">
       <p>Ordinateur avec au moins 4 Go de RAM</p>
       <p>Compréhension de base du réseau (adresses IP, ping)
  ...
  <div class="container alt section-space">
    <div class="row">
      <div class="col-xs-12 text-center">
        <h3 class="h3 u-bold text-cent  er u-margin-b-sm">Apprenez avec un formateur en salle.<br>
          Tout a été fait pour vous permettre d'apprendre sereinement<br>
            Suivez notre atelier pratique et démarrez une nouvelle carrière dans la sécurité informatique</h3>
        <div class="c-browser">
...
.</p>
  ...
  <div class="container alt section-space">
    <div class="row">
      <div class="col-xs-12">
        <h3 class="h3 u-bold text-center u-margin-b-sm u-margin-t-sm">Pourquoi Oschool ?</h3>
      </div>
    </div>
...
<section _ngcontent-c55="" class="nd-syllabus-term__cards ng-star-inserted">
  <div _ngcontent-c55="" class="cards_contain contain contain--none">
    ...
    <!---->
    <!---->
    <!----><a _ngcontent-c55="" class="button--secondary lg syllabus-download-button ng-star-inserted" target="_blank" href="https://docs.google.com/document/d/1ul5GKRzMHaHgj7-5cZ5EwwyjNcyOHbdSSs-3Fw16qnw/edit?usp=sharing">
                ...
                <ul _ngcontent-c95="" class="ng-star-inserted">
                  ...
                  <li _ngcontent-c95="" class="ng-star-inserted">
                    <div _ngcontent-c95="" class="part">
                      <header _ngcontent-c95="" class="part__header mb-half">
                        <!---->
                        <h4 _ngcontent-c95="" class="h5 mb-0 ng-star-inserted">Projet</h4>
                        <!---->
                      </header>
      ...
      <div _ngcontent-c63="" class="cards_contain contain contain--none ng-star-inserted">
        ...
        <ir-degree-pricing-card _ngcontent-c63="" _nghost-c101="" class="ng-star-inserted">
          <div _ngcontent-c101="" class="card card--pricing primary selected more-padding-top">
            ...
            <!---->
            <h6 _ngcontent-c101="" class="card__flag ng-star-inserted">Prix</h6>
            ...
            <div class="form-group password-form-group">
              <div class="input-with-icon">
                <select class="form-control" name="formation">
                  <option value="Hacking Kali Linux">Hacking Kali Linux</option>
                </select>
                <i class="input-icon ion-person-stalker"></i>
              </div>
            </div>
