                            ...
                            <div class="setting-container--nav--1uLCY">
                              <nav>
                                ...
                                <ul id="tabs" class="_nav--submenu-wrapper--3Mz7w">
                                  <li class="_nav--submenu-container--3FWhR"><a href="#info" class="active _nav--submenu-link--ZUUQK _nav--item--3mD7y">A propos </a></li>
                                  <!--
                                ...
                                -->
                                  ...
                                  <li class="_nav--submenu-container--3FWhR"><a href="#livrables" class="_nav--submenu-link--ZUUQK _nav--item--3mD7y">Livrables de {{$user->name}}</a></li>
                                  <li class="_nav--submenu-container--3FWhR"><a href="#sessions" class="_nav--submenu-link--ZUUQK _nav--item--3mD7y">Les sessions de {{$user->name}}</a></li>
                                  @endif
                                  <li class="_nav--submenu-container--3FWhR"><a href="#courses" class="_nav--submenu-link--ZUUQK _nav--item--3mD7y">Les cours de {{$user->name}}</a></li>

                                  @if(Auth::user()->type3 == 'admin' && $user->type2 == 'teacher')
                                  <li class="_nav--submenu-container--3FWhR"><a href="#teacher" class="_nav--submenu-link--ZUUQK _nav--item--3mD7y">Les étudiant.es de {{$user->name}}</a></li>
                                  @endif
                                  ...
                                  <li class="_nav--submenu-container--3FWhR"><a href="{{url('inscrire', $user)}}" class="_nav--submenu-link--ZUUQK _nav--item--3mD7y">Inscrire à une formation </a></li>
                                  <li class="_nav--submenu-container--3FWhR">
                                    <form action="{{ route('users.destroy', $user) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('delete') }}
                                        <button style="color: red;" class="_nav--submenu-link--ZUUQK _nav--item--3mD7y" type="submit">Supprimer ce compte utilisateur</button>
                                    </form>
                                  </li>
                                  @endif
