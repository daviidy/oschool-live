                    ...
                    <main class="_layout-module--main--20EWg">
                            ...
                            <div data-test="course-header">
                              <div class="index--container--GSOp4">
                                <div class="index--lesson-info-small--1DtXu shared--outer-container--3eppq">
                                  ...
                                  <div class="index--title-container--2XSQg">
                                    <h5 class="index--lesson-subtitle-small--3QwkE shared--subtitle-small--1lMk2">@yield('titre')</h5>
                                    <h3 class="index--lesson-title-small--330mG shared--title-small--2y2ao">@yield('description')</h3>
                                  </div>
                                  <div><button class="vds-button vds-button--primary" type="button"><span class="vds-button__content"> <a href="{{url('home')}}">Page d'accueil</a> </span></button></div>
                                </div>
                                <div class="index--deadline-bar-small--2Rrw7">
                                  <div class="deadline-bar--container--djlS_">
                                    <div class="deadline-bar--content--X6Lwt shared--outer-container--3eppq">
                                      <p class="deadline-bar--large-info--3EH-W">Get Your Startup Started</p>
                                      <div class="deadline-bar--inner-content-container--ofeiZ">
                                        <div class="deadline-bar--content-context-label--1mbKu">
                                          <h4 class="deadline-bar--title--pN0sH shared--subtitle-small--1lMk2">7% viewed</h4>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      <div class="_layout-module--content-area--tGmoA" style="background-color: rgb(250, 251, 252);">
                            ...
                            <div>
                              <div data-test="course-header">
                                <div class="index--container--GSOp4">
                                  <div class="index--lesson-info-small--1DtXu shared--outer-container--3eppq">
                                    <div class="index--title-container--2XSQg">
                                      <h5 class="index--lesson-subtitle-small--3QwkE shared--subtitle-small--1lMk2">Your Latest Activity</h5>
                                      <h3 class="index--lesson-title-small--330mG shared--title-small--2y2ao">Lesson 1: Set Your Goals</h3>
                                    </div>
                                    <div><button class="vds-button vds-button--primary" type="button"><span class="vds-button__content">Resume Lesson 1</span></button></div>
                                  </div>
                                  <div class="index--deadline-bar-small--2Rrw7">
                                    <div class="deadline-bar--container--djlS_">
                                      <div class="deadline-bar--content--X6Lwt shared--outer-container--3eppq">
                        ...
                        <div id="main-layout-content" aria-labelledby="header-title" class="_body-module--body--UXv_5">
                          <div>
                            <div data-test="course-syllabus" class="_syllabus--container--yhez7 shared--outer-container--3eppq">
                              <ol>
                                @yield('content')
                              </ol>
                            </div>
