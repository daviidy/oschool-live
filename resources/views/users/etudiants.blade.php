...
<section id="main-content">
  <section class="wrapper">
    ...
    <div class="row mt">
      ...
      <h2 style="text-align: center;">Mes étudiants</h5><br>
          ...
          <div class="emply-resume-sec">
            ...
            <div class="emply-resume-list">
              <div class="emply-resume-thumb">
                <img src="/avatars/users/{{$student->photo}}" alt="">
              </div>
              <div class="emply-resume-info">
                <h3><a href="{{url('users', $student)}}" title="">{{$student->name}}</a></h3>
                @foreach($student->formations as $formation)
                <span><i>{{$formation->nom}}</i> ({{$student->email}})</span>
                @endforeach
                @foreach($student->formations as $formation)
              ...
              <div class="shortlists">
                <a href="{{url('users', $student)}}" title="">Voir les infos <i class="fa fa-info"></i></a>
              </div>
            </div><!-- Emply List -->
            @endforeach
