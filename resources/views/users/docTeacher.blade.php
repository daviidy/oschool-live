    ...
    <div class="chat-room mt">
      <aside class="mid-side">
        ...
        <div class="room-desk">
          ...
          <div class="room-box">
            <h5 class="text-primary"><a target="_blank" href="https://drive.google.com/open?id=1Rae0RAkXdhfIYSA-eQkw8kH4KGYaJ9KN0Tz5nA5EjN8">Réaliser ma première session (session "rookie")</a></h5>
