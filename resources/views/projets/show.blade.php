...
<html lang="fr">
	<head>
    <title>Envoyer unn livrable | Oschool</title>
		<meta charset="UTF-8">
    ...
    <div class="container-contact100">
        ...
        <h4>Formation concernée:
            ...
            @endforeach
				...
				<form style="margin-top: 20px;" method="post" enctype="multipart/form-data" action="{{route('etatprojets.store')}}" class="contact100-form validate-form">
					{{ csrf_field() }}

					<div style="display: none;" class="wrap-input100 input100-select bg1">
						<span class="label-input100">USER_ID</span>
                        <div class="form-group has-warning has-feedback">
	                        <label for="inputWarning2">Identifiant utilisateur</label>
	                        <input readonly value="{{Auth::user()->id}}" name="user_id" type="text" class="form-control" id="inputWarning2">
          ...
          <div class="wrap-input100 input100-select bg1">
					...
					<div class="wrap-input100 input100-select bg1">
                        ...
                        <div class="form-group has-warning has-feedback">
	                        <label for="inputWarning2">Donnez l'url du livrable</label>
	                        <input required name="livrables" type="url" class="form-control" id="inputWarning2">
	                        <span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
                        </div>
					</div>
