...
<html lang="fr">
	<head>
		<title>Modifier un projet | Oschool</title>
		<meta charset="UTF-8">
          ...
          {{ method_field('patch') }}
					...
					<div class="wrap-input100 input100-select bg1">
                        ...
                        <div class="form-group has-warning has-feedback">
	                        ...
	                        <input value="{{$projet->name}}" required name="titre" type="text" class="form-control" id="inputWarning2">
					...
					<div class="wrap-input100 input100-select bg1">
                        ...
                        <div class="form-group has-warning has-feedback">
	                        ...
	                        <input value="{{$projet->url}}" required name="enonce" type="url" class="form-control" id="inputWarning2">
	                        <span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
                        </div>
					</div>
