    ...
    <div class="
        ...
        <div class="flex flex-column relative tc pt4">
          <div class="
            ...
            <div class="
                    ...
                    css-19yvy3u
                  "><img src="/avatars/projects/{{$projet->image}}"
          ...
          <h2 class="
              ...
              css-128nlh6
            "><span class="mh1">•</span>{{$formation->nom}}</h2>
          @endforeach
          <div class="
            ...
            <h3 class="
              ...
              css-hxrs45
            "><a href="{{ $projet->enonce }}">{{$projet->titre}}</a></h3>
          </div>
        </div>
      </div>
      <div class="
      ...
      ">
        <div class="flex items-center ph3 pb3 pt2">
          <div class="flex-grow-1 flex items-center"><a href="{{ route('projets.edit', $projet) }}"><img src="https://1001freedownloads.s3.amazonaws.com/vector/thumb//Anonymous_Pencil_icon.png" alt="Nik Graf" title="Nik Graf" class="
                db br-pill
                css-1i4zz36
              "></a>
            ...
            <div class="ml2">
              ...
              <div class="
                    ...
                    css-1qxtz39
                  ">
                <div class="lh-solid flex items-center">{{$projet->formations->count()}}
                  <!-- --> formations concernées<span class="flex items-center">&nbsp;·&nbsp;
                    <!-- --23m--></span></div>
              </div>
            </div>
          </div>
