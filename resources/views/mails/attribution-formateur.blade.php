...
<body>
  <table style="width:100%;max-width:960px;position: relative;left:0;right:0;margin: 0 auto;border-collapse: collapse;border-spacing: 0;font-size: 14px;line-height: 24px;color: #333;font-family: Microsoft YaHei;">
    ...
    <tr>
      <td style="padding: 20px 7.5% 0;">Vous venez d'être attibué à un nouveau formateur !</td>
    </tr>

    <tr>
      <td style="padding: 20px 7.5% 0;"> Voici les infos du formateur <br>
        Nom d'utilisateur: <strong>{{$user->teacher->name}}</strong> <br>
        Email: <strong>{{$user->teacher->email}}</strong> <br>
      </td>
    </tr>

    <tr>
      <td style="padding: 20px 7.5% 0;">
        Il vous contactera dans les plus brefs délais. Nous espérons qu'avec ce formateur, vous atteindrez vos objectifs<br>
        <a href="{{url('users', $user->teacher->name)}}">Consultez le profil du formateur</a><br>
