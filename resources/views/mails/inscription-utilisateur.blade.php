...
<body>
  <table style="width:100%;max-width:960px;position: relative;left:0;right:0;margin: 0 auto;border-collapse: collapse;border-spacing: 0;font-size: 14px;line-height: 24px;color: #333;font-family: Microsoft YaHei;">
    ...
    <tr>
      <td style="padding: 20px 7.5% 0;">Par ce mail, nous vous informons que votre compte a bien été crée sur Oschool Live :</td>
    </tr>

    <tr>
      <td style="padding: 20px 7.5% 0;"> Voici les infos de votre compte <br>
        Nom d'utilisateur: <strong>{{$user->name}}</strong> <br>
        Mot de passe: Votre mot de passe <br>
      </td>
    </tr>
