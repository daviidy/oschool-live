						...
						<table width="620" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td valign="top" width="360" class="text" style="color:#7d7d7d; font-family:Arial; font-size:12px; line-height:20px; text-align:left">
									<div>
										<div class="h2-blue" style="color:#509bcb; font-family:'Trebuchet MS'; font-size:22px; line-height:26px; text-align:left; font-weight:bold"><div>Bienvenue à Oschool, {{$achat->prenoms}} !</div></div>
									...
									<div>
										<div class="h2-orange" style="color:#eb8400; font-family:'Trebuchet MS'; font-size:22px; line-height:26px; text-align:left; font-weight:bold"><div>Etapes à effectuer</div></div>
										<div style="font-size:0pt; line-height:0pt; height:10px"><img src="/email/images/empty.gif" width="1" height="10" style="height:10px" alt="" /></div>

										<div class="img" style="font-size:0pt; line-height:0pt; text-align:left">
											<img src="/email/images/separator2.jpg" alt="" border="0" width="360" height="2" />
										</div>
										<div style="font-size:0pt; line-height:0pt; height:15px"><img src="/email/images/empty.gif" width="1" height="15" style="height:15px" alt="" /></div>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td valign="top" class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="130"><img src="/email/images/img.png" alt="" border="0" width="115" height="115" /></td>
												<td valign="top" class="text" style="color:#7d7d7d; font-family:Arial; font-size:12px; line-height:20px; text-align:left">
													<div class="h3" style="color:#7ba436; font-family:Arial; font-size:14px; line-height:18px; text-align:left; font-weight:bold">
														<div>Te connecter à ton compte Oschool</div>
													</div>
													<div style="font-size:0pt; line-height:0pt; height:10px"><img src="/email/images/empty.gif" width="1" height="10" style="height:10px" alt="" /></div>
														...
														<tr>
															<td align="left">
																<table border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="20"><img src="/email/images/bullet2.jpg" alt="" border="0" width="13" height="10" /></td>
																		<td><div><a href="https://code.oschool.ci/login" target="_blank" class="link" style="color:#7ba436; text-decoration:none"><span class="link" style="color:#7ba436; text-decoration:none">Voir le compte</span></a></div></td>
																	</tr>
																</table>
															</td>
														</tr>
										...
										<div style="font-size:0pt; line-height:0pt; height:30px"><img src="/email/images/empty.gif" width="1" height="30" style="height:30px" alt="" /></div>

										<div class="img" style="font-size:0pt; line-height:0pt; text-align:left">
											<img src="/email/images/separator3.jpg" alt="" border="0" width="360" height="1" />
										</div>
										<div style="font-size:0pt; line-height:0pt; height:25px"><img src="/email/images/empty.gif" width="1" height="25" style="height:25px" alt="" /></div>



										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td valign="top" class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="130"><img src="/email/images/img02.png" alt="" border="0" width="115" height="115" /></td>
												<td valign="top" class="text" style="color:#7d7d7d; font-family:Arial; font-size:12px; line-height:20px; text-align:left">
													<div class="h3" style="color:#7ba436; font-family:Arial; font-size:14px; line-height:18px; text-align:left; font-weight:bold">
														<div>Assister à la réunion de rentrée</div>
													</div>
													<div style="font-size:0pt; line-height:0pt; height:10px"><img src="/email/images/empty.gif" width="1" height="10" style="height:10px" alt="" /></div>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td valign="top" class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="130"><img src="/email/images/img03.png" alt="" border="0" width="115" height="115" /></td>
												<td valign="top" class="text" style="color:#7d7d7d; font-family:Arial; font-size:12px; line-height:20px; text-align:left">
													<div class="h3" style="color:#7ba436; font-family:Arial; font-size:14px; line-height:18px; text-align:left; font-weight:bold">
														<div>Nous contacter pour toute autre préoccupation</div>
													</div>
													<div style="font-size:0pt; line-height:0pt; height:10px"><img src="/email/images/empty.gif" width="1" height="10" style="height:10px" alt="" /></div>

													<div>
														Si vous avez des questions merci d'écrire à support@oschool.ci
													</div>
													<div style="font-size:0pt; line-height:0pt; height:10px"><img src="/email/images/empty.gif" width="1" height="10" style="height:10px" alt="" /></div>
												</td>
											</tr>
