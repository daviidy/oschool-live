						...
						<table width="620" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td valign="top" width="360" class="text" style="color:#7d7d7d; font-family:Arial; font-size:12px; line-height:20px; text-align:left">
									<div>
										<div class="h2-blue" style="color:#509bcb; font-family:'Trebuchet MS'; font-size:22px; line-height:26px; text-align:left; font-weight:bold"><div>Nouvel inscription à Oschool Live !</div></div>
										...
										<div>
											Nouvelle inscription à la formation qualifiante Développeur Web Junior en télé présentiel !
											Voici les infos du nouvel étudiant:
											<ul>
												<li>Nom: {{$achat->nom}}</li>
									...
									<div>
											...
											<tr>
												...
												<td valign="top" class="text" style="color:#7d7d7d; font-family:Arial; font-size:12px; line-height:20px; text-align:left">
													<div class="h3" style="color:#7ba436; font-family:Arial; font-size:14px; line-height:18px; text-align:left; font-weight:bold">
														<div>Crée lui un compte Oschool Code</div>
													</div>
													<div style="font-size:0pt; line-height:0pt; height:10px"><img src="/email/images/empty.gif" width="1" height="10" style="height:10px" alt="" /></div>

													<div>
														Avec pour identifiant
														<ul>
															<li>Email: {{$achat->email}}</li>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td valign="top" class="text" style="color:#7d7d7d; font-family:Arial; font-size:12px; line-height:20px; text-align:left">
													<div class="h3" style="color:#7ba436; font-family:Arial; font-size:14px; line-height:18px; text-align:left; font-weight:bold">
														<div>Mets le dans la liste mail des étudiants Oschool Code et prépare le pour la réunion de rentrée</div>
													</div>
													<div style="font-size:0pt; line-height:0pt; height:10px"><img src="/email/images/empty.gif" width="1" height="10" style="height:10px" alt="" /></div>
